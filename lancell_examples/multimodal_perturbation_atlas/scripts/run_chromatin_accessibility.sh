#!/usr/bin/env bash
# Run chromatin accessibility (scATAC-seq) ingestion scripts against a shared atlas.
# Usage: ./run_chromatin_accessibility.sh /path/to/atlas [--limit N]
set -euo pipefail
...
SCRIPTS=(
    # lancell_examples.multimodal_perturbation_atlas.scripts.ingest_GSE161002
    lancell_examples.multimodal_perturbation_atlas.scripts.ingest_GSE168851
)
