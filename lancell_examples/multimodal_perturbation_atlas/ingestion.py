"""Ingestion utilities for chromatin accessibility fragment data.

Parses gzipped 4-column BED files (chrom, start, end, cell_barcode),
sorts fragments into cell order and genome order, and writes the parallel
zarr arrays expected by ``CHROMATIN_ACCESSIBILITY_SPEC``:
